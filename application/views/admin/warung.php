...
?>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a target="_blank"
                                                            href="<?=base_url('assets/uploads/') . $warung['ktp']?>"
                                                            class="btn dropdown-item"> Lihat KTP </a>
                                                        <!-- <a href="<?php ?>" class="btn btn-sm btn-warning px-3 mb-2"> Edit </a> -->
                                                        <?php if ($warung['is_aktif'] == 0) {?>
                                                        <?php if ($warung['status'] == 'Sudah diverifikasi') {?>
                                                        <a href="<?php echo site_url('admin/aktifasi_warung/') . $warung['id'] ?>/1"
                                                            class="btn dropdown-item"
                                                            onclick="return confirm('Apakah Anda yakin ingin mengaktifkan warung?')">
                                                            Aktifkan </a>
                                                        <?php }?>
                                                        <?php } else {?>
                                                        ...
                                                        <a href="<?php echo site_url('admin/keterangan_non_warung/') . $warung['id'] ?>"
                                                            class="btn btn-sm btn-danger px-3 mb-2 btn-block text-left"
                                                            onclick="return confirm('Apakah Anda yakin nonaktifkan?')">
                                                            Nonaktifkan </a>
                                                        <?php }?>
                                                        <?php if ($warung['status'] != 'Sudah diverifikasi') {?>
                                                        <a href="<?php echo site_url('admin/approve/') . $warung['username'] ?>"
                                                            class="btn dropdown-item "> Approve </a>
                                                        <a href="<?php echo site_url('admin/keterangan_un_warung/') . $warung['username'] ?>"
                                                            class="btn dropdown-item"
                                            ...
                                            <td>
                                                <a href="https://api.whatsapp.com/send?phone=<?php echo $warung['phone']; ?>&text=Saya%20mau%20bertanya%20tentang"
                                                    class="btn btn-outline-secondary btn-sm" target="_blank"><i
                                                        class="mdi mdi-whatsapp"></i> Chat</a>
                                            </td>
