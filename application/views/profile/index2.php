                               ...
                               <div class="col-12">
                                   <div class="banner__box">
                                       <a href="#" class="banner__link">
                                           ...
                                           <a href="<?php echo base_url('assets/images/no-photo.png') ?>"
                                               class="image-popup"><img
                                                   src="<?php echo base_url('assets/images/no-photo.png') ?>"
                                                   class="img-fluid"></a>
                                           <?php else: ?>
                                           <a href="<?php $photos = explode(',', $user['photo']);
echo base_url('assets/uploads/') . $photos[0]?>" class="image-popup mb-3"><img style="width:100%;margin-bottom:10px"
                                                   src="<?php $photos = explode(',', $user['photo']);
echo base_url('assets/uploads/') . $photos[0]?>" class="img-fluid"></a>
                                           <?php if ($this->session->userdata('username') == $user['username']): ?>
                                           <a class="btn btn-sm btn-primary py-2 px-5 text-white btn--block"
                                               data-toggle="modal" data-target="#modal-photo">Ganti Foto</a>
                                           <?php endif?>
                                           <?php endif;?>
                                       </a>
                                   </div>
                       ...
                       <div class="sidebar__widget gray-bg">
                           ...
                           <ul class="sidebar__menu-collapse">
                               ...
                               <p id="status" class="btn btn--box btn--small btn-sm py-2 px-5 btn--block text-white">
                               </p>
                               <?php endif;?>
                               <!-- Start Single Menu Collapse List -->
                               <li class="sidebar__menu-collapse-list">
                                   <div class="sidebar__box">
                                       <a href="<?php echo site_url('profile/edit/') . $user['username'] ?>"
                                           class="btn btn--box btn-warning btn--small btn-sm py-2 px-5 btn--block text-white">Ubah
                                           profile</a>
                                   </div>
                               </li> <!-- End Single Menu Collapse List -->
                               <p></p>
                               <li class="sidebar__menu-collapse-list">
                                   <div class="sidebar__box">
                                       <a data-toggle="modal" data-target="#modal-password"
                                           class="btn btn--box btn-secondary btn-sm py-2 px-5 text-white btn--small btn--block">Ganti
                                           password</a>
                                   </div>
                               </li> <!-- End Single Menu Collapse List -->
               ...
               <div class="col-lg-9">
                   ...
                   <?php endif;?>
                   <h5 class="sidebar__title">Etalase <?php echo $user['name']; ?>
                       <a class="btn btn-outline-primary">
                           <span style="color: #004080;">
                               <?=round($rating_warung['rating'])?> <i class="fas fa-star"></i>
                           </span>
                       </a>
                   </h5>
                   ...
                   <div class="container-fluid">
                       <div class="row justify-content-center">
                           <div class="col-sm-12 ftco-animate">
                               <form method="POST"
                                   action="<?php echo site_url('profile/change_photo/') . $user['username'] ?>"
                               ...
                               <form method="POST"
                                   ...
                                   <div class="col-sm-12">
                                       <div class="form-group">
                                           ...
                                           <input type="password" required class="form-control" name="verif-newpassword"
                                               placeholder="New passsword">
