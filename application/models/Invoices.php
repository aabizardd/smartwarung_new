...
class invoices extends CI_Model
{
    ...
    public function get_all_invoices($username)
    {
        ...
        users.name warung_name, users.username warung_username, invoices.method, invoices.date, invoices.pdf_url
        ');
    ...
    {
        $this->db->select('items.id item_id,items.stock item_stock, invoice_details.quantity quantity, invoice_details.id invoice_id');
