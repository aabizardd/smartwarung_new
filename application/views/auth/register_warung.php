                                           ...
                                           <div class="tab-pane active">
                                               <div class="login-form-container">
                                                   <div class="login-register-form">
                                                       <form action="<?php echo site_url('auth/store_warung') ?>"
                                                           method="post" enctype='multipart/form-data'>
                                                           <div class="form-box__single-group">
                                                               <label>Nama Warung</label>
                                                               <input type="text" id="form-username" name="name"
                                                           ...
                                                           <div class="form-box__single-group">
                                                               ...
                                                               <input id="pac-input" class="form-control" type="text"
                                                                   name="address" placeholder="Masukkan alamat warung">
                                                           ...
                                                           <div class="form-box__single-group">
                                                               <label>Email</label>
                                                               <input type="email" id="form-username" name="email"
                                                                   placeholder="Email">
                                                           </div>
                                                           <div class="form-box__single-group">
                                                           ...
                                                           <div class="form-box__single-group">
                                                               ...
                                                               <input type="phone" id="form-username" name="phone"
                                                           ...
                                                           <div
                                                               ...
                                                               <a href=""></a>
                                                               <a class="link--gray"
                                                                   href="<?php echo base_url('auth/login') ?>">Login
                                                                   disini</a>
                                                           </div>
                                                           <button
                                                               class="btn btn--box btn--small btn--blue btn--uppercase btn--weight"
                                                               type="submit">DAFTAR WARUNG</button>
                                                       </form>
                                                   </div>
                                               </div>
                                           </div>
