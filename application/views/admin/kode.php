...
var options = {
    ...
    xaxis: {
        categories: [<?php foreach ($bulan_tersedia as $bln): ?> "<?=$bln?>",
            <?php endforeach?>
        ],
        title: {
            text: "Bulan"
...
if ($("#column_chart_datalabell").length) {
    options = {
        chart: {
            height: 350,
            type: "bar",
        ...
        xaxis: {
            categories: [<?php echo $nama_warung; ?>],
            position: "top",
            labels: {
                offsetY: -18
            },
        ...
        title: {
            text: "Total warung terlaris dengan pesanan selesai",
            floating: !0,
            offsetY: 320,
            align: "center",
            style: {
...
if ($("#column_chartt").length) {
    options = {
        ...
        series: [{
            name: "Pendapatan",
            data: [<?php echo $jumlahhh; ?>]
        }],
        colors: ["#3051d3"],
        xaxis: {
            categories: [<?php echo $nama_warungg; ?>]
        },
        yaxis: {
            title: {
                text: "Rp (Rupiah)"
...
if ($("#bar_chartt").length) {
    options = {
        ...
        xaxis: {
            categories: [<?php echo $nama_status; ?>]
        }
    };
...
?>
    ...
    <script type="text/javascript">
if ($("#pie_chartt").length) {
    options = {
        chart: {
            height: 320,
            type: "pie"
        },
        series: [<?php echo $jumlahhhhh; ?>],
        labels: [<?php echo $nama_statuss; ?>],
    ...
    (chart =
        new ApexCharts(document.querySelector("#pie_chartt"), options)).render()
}
    </script>