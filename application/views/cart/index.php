...
foreach ($carts as $item): ?>
                                   <tr>
                                       ...
                                       <td class="product-thumbnail">
                                           <img class="img-fluid" src="<?php $photos = explode(',', $item['photo']);
echo base_url('assets/uploads/') . $photos[0]?>" alt="">
                                       </td>
                                       <td class="product-name">
                                           <p><?php echo $item['name'] ?></p>
                                           <a style="color: blue;"
                                               href="<?php echo site_url('profile/show/') . $item['warung_username'] ?>"><?php echo $item['warung_name'] ?></a>
                                       </td>
                                       <td class="product-price-cart"><span
                                               class="amount"><?php echo "Rp " . number_format($item['price'], 0, ".", ".") ?></span>
                                       </td>
...
?>
                                       ...
                                       <td class="product-remove">
                                           <a onclick="return confirm('Apakah Anda yakin akan menghapus?');"
                                               href="<?php echo site_url('cart/delete/') . $item['item'] ?>"><i
                   ...
                   <div class="cart-table-button m-t-10">
                       <div class="cart-table-button--left">
                           <a href="category"
                               class="btn btn--box btn--large btn--gray btn--uppercase btn--weight m-t-20">LANJUTKAN
                               BELANJA</a>
                       </div>
                       <div class="cart-table-button--right">
                           <input type="submit"
                               class="btn btn--box btn--large btn--blue btn--uppercase btn--weight m-t-20"
                               value="PERBARUI KERANJANG BELANJA">
                       </div>
           ...
           <div class="row">
               ...
               <div class="col-lg-4 col-md-6">
                   ...
                   <div class="sidebar__widget gray-bg m-t-40">
                       ...
                       <h6 class="total-cost">Total
                           diskon<span><?php echo "<del>Rp " . number_format($discount, 0, ".", ".") . "</del>" ?></span>
                       </h6>
       ...
       <script>
       function getLoc() {
           var checkboxes = document.getElementsByName('choose-barang[]');
           var vals = "";
