                        ...
                        <div class="col-lg-3">
                            <div class="header__logo">
                                <a href="<?php echo base_url('') ?>" class="header__logo-link">
                                    <img src="<?php echo base_url('assets_user/') ?>img/logo/logo-color.png"
                                        height="50%" width="50%" alt="" class="header__logo-img">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-9">
                            <div class="row align-items-center">
                                <div class="col-lg-10">
                                    <form class="header__search-form"
                                        action="<?php echo base_url("home/pencarian/") ?>">
                                ...
                                <div class="col-lg-2">
                                    <div class="header__wishlist-box">
                                        ...
                                        <div class="header__wishlist pos-relative">
                                            ...
                                            <div class="user-info user-set-role">
                                                <a class="user-set-role__button" href="#" data-toggle="dropdown"
                                                    aria-haspopup="true"><i class="icon-eye"></i> </a>
                                        ...
                                        <div class="header__wishlist pos-relative m-l-20">
                                            ...
                                            <div class="user-info user-set-role">
                                                <a class="user-set-role__button" href="#" data-toggle="dropdown"
                                                    aria-haspopup="true"><i class="icon-user"></i> </a>
                                                <ul class="expand-dropdown-menu dropdown-menu">
                                                    <li><a href="<?php echo base_url('auth/login') ?>">Login</a></li>
                                                    <li><a href="<?php echo base_url('auth/register') ?>">Daftar
                                                            Pembeli</a></li>
                                                    <li><a href="<?php echo base_url('auth/register_warung') ?>">Daftar
                                                            Warung</a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="user-info user-set-role">
                                                ...
                                                <ul class="expand-dropdown-menu dropdown-menu">
                                                    ...
                                                    <li><a
                                                            href="<?php echo site_url('profile/etalase/') . $this->session->userdata('username') ?>">Etalase</a>
                                                    </li>
                                                    <li><a href="<?php echo site_url('item/create/') ?>">Tambah
                                                            Barang</a></li>
                                                    <li><a href="<?php echo site_url('profile/order') ?>">Pesanan
                                                            Masuk</a></li>
                                            ...
                                            <div class="user-info user-set-role">
                                                ...
                                                <ul class="expand-dropdown-menu dropdown-menu">
                                                    <li><a href="#">Hello,
                                                            <?php echo $this->session->userdata('name') ?></a></li>
                                                    <li><a href="<?php echo base_url('profile') ?>">Akun</a></li>
                                                    <li><a href="<?php echo base_url('profile/order') ?>">Pesanan</a>
                                                    </li>
                                                    <li><a href="<?php echo base_url('auth/logout') ?>">Logout</a></li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="header-add-cart pos-relative m-l-30">
                                            ...
                                            <a href="<?php echo base_url('cart') ?>">
                                                ...
                                                <span
                                                    class="wishlist-item-count pos-absolute"><?php echo count($this->carts->get_all($this->session->userdata('username'))) ?></span>
                                            </a>
                                            <?php elseif ($this->session->userdata('role') == 1): ?>
                                            <?php elseif ($this->session->userdata('role') == 0): ?>
                                            <a href="<?php echo base_url('cart') ?>">
