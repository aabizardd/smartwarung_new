                       ...
                       <div class="sidebar__widget gray-bg">
                           ...
                           <ul class="sidebar__menu-collapse">
                               ...
                               <li class="sidebar__menu-collapse-list">
                                   <div class="accordion">
                                       <a href="<?php echo site_url('category/') ?>" class="accordion__title">Semua
                                           Kategori </a>
                                   </div>
                               ...
                               <li class="sidebar__menu-collapse-list">
                                   <div class="accordion">
                                       <a data-toggle="dropdown" class="accordion__title">
                                           Kamar Mandi
                                       </a>
                                       <div class="dropdown-menu">
                                           <a class="dropdown-item"
                                               href="<?php echo site_url('category/show/7') ?>">Kebersihan</a>
                                           <a class="dropdown-item"
                                               href="<?php echo site_url('category/show/8') ?>">Perlengkapan Mandi</a>
                                       </div>
                                   </div>
                               </li>
                               ...
                               <li class="sidebar__menu-collapse-list">
                                   <div class="accordion">
                                       <a href="<?php echo site_url('category/show/') . $category['id'] ?>"
                                           class="accordion__title"><?php echo $category['name'] ?> </a>
                                   </div>
                               </li> <!-- End Single Menu Collapse List -->
