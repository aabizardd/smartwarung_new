        ...
        <div id="offcanvas-add-cart__box" class="offcanvas offcanvas-cart offcanvas-add-cart">
            ...
            <ul class="offcanvas-add-cart__menu">
                ...
                <li class="offcanvas-add-cart__list pos-relative">
                    <div class="offcanvas-add-cart__img-box pos-relative">
                        <a href="single-1.html" class="offcanvas-add-cart__img-link img-responsive"><img
                                src="<?php echo base_url('assets_user/') ?>img/product/size-small/product-home-1-img-1.jpg"
                    ...
                    <div class="offcanvas-add-cart__detail">
                        <a href="single-1.html" class="offcanvas-add-cart__link">PlayStation 4 Pro 1TB Star Wars
                            Battlefront II Bundle</a>
                ...
                <li class="offcanvas-add-cart__list pos-relative">
                    <div class="offcanvas-add-cart__img-box pos-relative">
                        <a href="single-1.html" class="offcanvas-add-cart__img-link img-responsive"><img
                                src="<?php echo base_url('assets_user/') ?>img/product/size-small/product-home-1-img-2.jpg"
                                alt="" class="add-cart__img"></a>
