...
function initMap() {
    var myLatlng = {
        lat: <?php echo $warung['lat'] ?>,
        lng: <?php echo $warung['lng'] ?>
    };
...
<script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBnAQMVvRRzgVVF5DKMkQqjWRr-R70vsXg&callback=initMap"></script>
</body>
