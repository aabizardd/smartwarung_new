           ...
           <div class="row flex-column-reverse flex-lg-row">
               ...
               <div class="col-lg-3">
                   ...
                   <div class="sidebar">
                       ...
                       <!-- Start Single Sidebar Widget -->
                       <div class="sidebar__widget gray-bg">
                           <form action="<?php echo base_url('home/hasil/') ?>" method="POST">
                               <div class="sidebar__box">
                                   ...
                                   <li class="sidebar__menu-filter-list">
                                       <div class="form-check">
                                           <input class="form-check-input" type="checkbox"
                                               value="<?php echo $category['id'] ?>" id="<?php echo $category['id'] ?>">
                                           <label class="form-check-label ml-4" for="<?php echo $category['id'] ?>">
                               ...
                               <input type="text" name="kategori" id="kategori" value="" hidden>
                               ...
                               <div class="sidebar__price-filter ">
                                   ...
                                   <div class="slider__price-filter-input d-flex justify-content-between">
                                       <input type="number" name="budmin" min=0 max="990000"
                                           oninput="validity.valid||(value='0');" id="min_price"
                                           class="price-range-field" />
                                       <input type="number" name="budmax" min=0 max="1000000"
                               ...
                               <div class="sidebar__box">
                                   <br>
                                   <button class="btn btn--block btn--small btn--blue btn--uppercase btn--weight"
                                       type="submit" id="cari">Cari</button>
                               </div>
