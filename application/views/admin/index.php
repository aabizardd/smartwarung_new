                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-6">
                                                    <h5>Welcome,</h5>
                                                    <p class="text-muted">
                                                        <?php echo ucwords($this->session->userdata('name')) ?></p>

                                                    <div class="mt-4">
                                                        <a href="<?php echo site_url('auth/logout') ?>"
                                                            class="btn btn-primary btn-sm">Logout <i
                                                ...
                                                <div class="col-5 ml-auto">
                                                    <div>
                                                        <img src="<?php echo base_url('assets_admin/') ?>images/widget-img.png"
                                                            alt="" class="img-fluid">
                                                    </div>
                                                </div>
                                            </div>
    ...
    echo "<h4>Rp " . number_format($key->total, 0, ".</h4>", ".");
                                                ...
                                                <div dir="ltr" class="ml-2">
                                                    <input data-plugin="knob" data-width="56" data-height="56"
                                                        data-linecap=round data-displayInput=false
                                                        data-fgColor="#3051d3" value="100" data-skin="tron"
                                            ...
                                            <div class="media">
                                                <div class="media-body">
                                                    <h5 class="mb-0"> *<span class="font-size-14 text-muted ml-1">Jumlah
                                                            termasuk ongkir</span></h5>
                                                </div>
...
foreach ($orders as $key): ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="badge badge-soft-primary">Belum melakukan
                                                                    pembayaran
                                                                </div>
