                            ...
                            <div class="card-body">
                                ...
                                <div class="card-title-desc">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#transfer"
                                                role="tab" aria-controls="home" aria-selected="true">
                                                <i
                                                    class="mdi mdi-credit-card-outline font-size-18 mr-1 align-middle"></i>
                                                <span class="d-none d-md-inline-block">Transfer</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#cash"
                                                role="tab" aria-controls="profile" aria-selected="false">
                                                <i class="mdi mdi-cash-usd-outline font-size-18 mr-1 align-middle"></i>
                                                <span class="d-none d-md-inline-block">Cash</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
...
foreach ($billings as $warung): ?>
                                                <tr>
                                                    <td><?=$no?></td>
                                                    <td><a href="<?php echo site_url('profile/show/') . $warung['username'] ?>"
                                                            class=""><?php echo $warung['username'] ?></a></td>
                                                    <td><?php echo "Rp " . number_format($warung['total'], 0, ".", ".") ?>
                                                    </td>
                                                    <td>
...
?>
                                                    ...
                                                    <td>
                                                        <?php if ($warung['bukti'] != "") {?>
                                                        <a href="<?=base_url()?>assets/bukti_trf_admin/<?=$warung['bukti']?>"
...
?>
                                                    ...
                                                    <td>
                                                        <?php if ($warung['status'] != "Sudah ditransfer") {?>
                                                        <a href="<?php echo site_url('admin/transfer_warung/') . $warung['id'] . '/' . $warung['username'] ?>"
                                                            class="btn btn-outline-secondary btn-sm"
                                                            onclick="return confirm('Apakah Anda yakin ingin transfer ke warung?')"><i
                                                                class="mdi mdi-bank-transfer-out"></i> Transfer</a>
                                                        <?php }?>
                                                    </td>
                                                </tr>
                                                <?php $no++;
