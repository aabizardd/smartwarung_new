                ...
                <!-- Selectize -->
                <script src="<?php echo base_url('assets_admin/') ?>libs/selectize/js/standalone/selectize.min.js">
                </script>

                <!-- datepicker -->
                <script src="<?php echo base_url('assets_admin/') ?>libs/air-datepicker/js/datepicker.min.js"></script>
                <script src="<?php echo base_url('assets_admin/') ?>libs/air-datepicker/js/i18n/datepicker.en.js">
                </script>

                <script
                    src="<?php echo base_url('assets_admin/') ?>libs/bootstrap-touchspin/jquery.bootstrap-touchspin.min.js">
                </script>
                <script
                    src="<?php echo base_url('assets_admin/') ?>libs/bootstrap-maxlength/bootstrap-maxlength.min.js">
                </script>

                <!-- Required datatable js -->
                <script src="<?php echo base_url('assets_admin/') ?>libs/datatables.net/js/jquery.dataTables.min.js">
                </script>
                <script
                    src="<?php echo base_url('assets_admin/') ?>libs/datatables.net-bs4/js/dataTables.bootstrap4.min.js">
                </script>

                <!-- Buttons examples -->
                <script
                    src="<?php echo base_url('assets_admin/') ?>libs/datatables.net-buttons/js/dataTables.buttons.min.js">
                </script>
                <script
                    src="<?php echo base_url('assets_admin/') ?>libs/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js">
                </script>
                ...
                <script
                    src="<?php echo base_url('assets_admin/') ?>libs/datatables.net-buttons/js/buttons.html5.min.js">
                </script>
                <script
                    src="<?php echo base_url('assets_admin/') ?>libs/datatables.net-buttons/js/buttons.print.min.js">
                </script>
                <script
                    src="<?php echo base_url('assets_admin/') ?>libs/datatables.net-buttons/js/buttons.colVis.min.js">
                </script>
                <!-- Responsive examples -->
                <script
                    src="<?php echo base_url('assets_admin/') ?>libs/datatables.net-responsive/js/dataTables.responsive.min.js">
                </script>
                <script
                    src="<?php echo base_url('assets_admin/') ?>libs/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js">
                </script>
