                                    ...
                                    <ul class="nav account-menu-list flex-column nav-pills" id="pills-tab"
                                        ...
                                        <li>
                                            <a class="active link--icon-left" id="pills-dashboard-tab"
                                                data-toggle="pill" href="#pills-dashboard" role="tab"
                                                aria-controls="pills-dashboard" aria-selected="true"><i
                                                    class="fas fa-tachometer-alt"></i> Dashboard</a>
                                        </li>
                                        <li>
                                            <a id="pills-order-tab" class="link--icon-left" data-toggle="pill"
                                                href="#pills-order" role="tab" aria-controls="pills-order"
                                                aria-selected="false"><i class="fas fa-shopping-cart"></i> Pesanan</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a class="link--icon-left" href="<?php echo site_url('auth/logout') ?>"><i
                                    ...
                                    <div class="tab-pane fade show active" id="pills-dashboard" role="tabpanel"
                                        ...
                                        <div class="my-account-dashboard account-wrapper">
                                            ...
                                            <div class="welcome-dashboard m-t-30">
                                                <p>Hello, <strong><?php echo $user['name'] ?></strong> (Jika bukan
                                                    <strong><?php echo $user['name'] ?> !</strong> <a
                                                        href="<?php echo site_url('auth/logout') ?>">Logout</a> )</p>
                                            </div>
                                            <p class="m-t-25">Dari dashboard akun, anda dapat dengan mudah memeriksa
                                                pesanan terakhir, mengatur akun dan mengubah password.</p>
                                        </div>
                                    </div>
...
foreach ($invoices as $invoice): ?>
                                                        <tr>
                                                            <td><?php echo $i++; ?></td>
                                                            <td><?=date("d M Y H:i", strtotime($invoice['date']));?>
                                                            </td>
                                                            <td>
                                                                <span class="amount">
...
?>
                                                            ...
                                                            <td>
                                                                ...
                                                                <span
                                                                    class="text-warning"><?php echo $invoice['invoice_status'] ?></span>
                                                                <?php elseif ($invoice['invoice_status'] == "Menunggu verif pembayaran"): ?>
                                                                <span
                                                                    class="text-warning"><?php echo $invoice['invoice_status'] ?></span>
                                                                <?php elseif ($invoice['invoice_status'] == "Sedang dikirim"): ?>
                                                                <span
                                                                    class="text-info"><?php echo $invoice['invoice_status'] ?></span>
                                                                <?php elseif ($invoice['invoice_status'] == "Sudah diterima"): ?>
                                                                <span
                                                                    class="text-success"><?php echo $invoice['invoice_status'] ?></span>
                                                                <?php elseif ($invoice['invoice_status'] == "Dibatalkan"): ?>
                                                                <span
                                                                    class="text-danger"><?php echo $invoice['invoice_status'] ?></span>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-box__single-group">
                                                            ...
                                                            <img height="50%" width="50%"
                                                                src="<?php echo base_url('assets/images/no-photo.png') ?>"
                                                                class="img-fluid">
                                                            <?php else: ?>
                                                            <img height="50%" width="50%" src="<?php $photos = explode(',', $user['photo']);
echo base_url('assets/uploads/') . $photos[0]?>" class="img-fluid">
                                                            <?php endif;?>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-box__single-group">
                                                            <a class="btn btn--box btn--small btn--uppercase btn--blue"
                                                                href="<?php echo site_url('profile/edit/') . $user['username'] ?>">Ubah
                                                                Detail Akun</a>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-box__single-group">
                                                            <button
                                                                ...
                                                                data-toggle="modal" data-target="#modal-password">Ubah
                                                                Password</button>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="container-fluid">
                        <div class="row justify-content-center">
                            <div class="col-sm-12 ftco-animate">
                                <form method="POST"
                                    action="<?php echo site_url('profile/change_password/') . $user['username'] ?>">
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="password" required class="form-control"
                                                name="verif-newpassword" placeholder="New passsword">
