...
foreach ($photos as $photo): ?>
                                   <div class="product-image--large overflow-hidden">
                                       <img class="img-fluid" id="img-zoom"
                                           src="<?php echo base_url('assets/uploads/') . $photo ?>"
                                           data-zoom-image="<?php echo base_url('assets/uploads/') . $photo ?>" alt="">
                                   </div>
                                       ...
                                       <div id="gallery-zoom"
                                           ...
                                           <div class="swiper-wrapper">
                                               <div class="swiper-slide">
                                                   <a class="zoom-active"
                                                       data-image="<?php echo base_url('assets/uploads/') . $photo ?>"
                                                       data-zoom-image="<?php echo base_url('assets/uploads/') . $photo ?>">
                                                       <img class="img-fluid"
                                                           src="<?php echo base_url('assets/uploads/') . $photo ?>"
                                                           alt="">
                                                   </a>
                           ...
                           <div class="col-md-6">
                               <div class="product-details-box">
                                   ...
                                   <span class="text-reference">Warung: <a
                                           href="<?php echo site_url('profile/show/') . $warung['username'] ?>"><?php echo $warung['name'] ?></a>
                                       <i class="icon-star"></i>
                                       <?php echo round($rating_warung['rating']) ?>
                                   </span>
                                   <div class="review-box">
                                       <ul class="product__review m-t-10 m-b-15">
                                           <li class="product__review--fill"><i class="icon-star"></i>
                                               <?php echo round($rating['rating']) ?></li>
                                       </ul>
                                   </div>
...
?>
                                   ...
                                   <div class="product-var p-t-30">
                                       ...
                                       <div class="product-color product-var__item">
                                           <button type="button" style="background-color: white; color: blue;"
                                       ...
                                       <div class="product-quantity product-var__item">
                                           <form id="target"
                                               action="<?php echo site_url('cart/store/') . $this->uri->segment(3) ?>"
                                               method="post">
                                       ...
                                       <div class="product-quantity product-var__item">
                                           <form id="target"
                                               action="<?php echo site_url('cart/store/') . $item['id'] ?>"
                                               method="post">
                                               <span class="product-var__text">Jumlah</span>
                                               <div class="product-quantity-box">
                                                   <div class="quantity">
                                                   ...
                                                   <button type="button"
                                                       class="btn btn--box btn--small btn--blue btn--uppercase btn--weight m-l-20"
                                                       onclick="pop()">Tambahkan ke keranjang</button>
                           ...
                           <div class="col-12">
                               <div class="section-content--border">
                                   <ul
                                       ...
                                       <li><a class="nav-link active" data-toggle="tab" href="#product-desc">Deskripsi
                                               Lengkap</a></li>
                                   ...
                                   <div class="tab-content">
                                       ...
                                       <div class="tab-pane" id="product-dis">
                                           <div class="product-dis__content">
                                               <a href="<?php echo site_url('profile/show/') . $warung['username'] ?>"
                                                   class="product-dis__img m-b-30"><img height="20%" width="20%"
                                                       src="<?php echo base_url('assets/uploads/') ?><?php echo $warung['photo'] ?>"
                                                       alt=""></a>
                                               <span>Nama Warung : <a
                                                       href="<?php echo site_url('profile/show/') . $warung['username'] ?>"><?php echo $warung['name'] ?></a></span>
                                           </div>
...
if (empty($tamp)) {
    ?>
                                                           <img src="<?php echo base_url('assets_user/') ?>img/user/image-1.png"
                                                               alt="">
                                                           <?php
} else {
    ?>
                                                           <img height="20%" width="20%"
                                                               src="<?php echo base_url('assets/uploads/') ?><?php echo $review['photo'] ?>"
                                                               alt="">
                                                           <?php
}
?>
                                                       ...
                                                       <div class="comment__content">
                                                           ...
                                                           <div class="para__content">
                                                               <p class="para__text"><?php echo $review['review'] ?>
                                                               </p>
                                                           </div>
                                                       </div>
                       ...
                       <div class="row">
                           <div class="col-12">
                               <div
                                   ...
                                   <h5 class="section-content__title">Produk lain di <a
                                           href="<?php echo site_url('profile/show/') . $warung['username'] ?>"><?php echo $warung['name'] ?></a>
                                       : </h5>
                               </div>
                           </div>
                                       ...
                                       <div class="swiper-wrapper">
                                           ...
                                           <div
                                               ...
                                               <div class="product__img-box">
                                                   <a href="<?php echo site_url('item/show/') . $key->id ?>"
                                                       class="product__img--link">
                                                       <img class="product__img" src="<?php $photos = explode(',', $key->photo);
                           ...
                           <div class="col-md-6">
                               <div class="modal-review-img">
                                   <img class="img-fluid  border-around"
                                       src="<?php echo base_url('assets_user/') ?>img/product/size-large/product-home-1-lg-img-1.jpg"
                                       alt="">
                               </div>
                               ...
                               <div class="product__desc m-t-15">
                                   <p>The ATH-S700BT offers clear, full-bodied audio reproduction with Bluetooth®
                                       wireless operation. The headphones are equipped with a mic, and music and volume
   ...
   <!-- Modal -->
   <div class="modal fade" id="priceListModal" tabindex="-1" role="dialog" aria-labelledby="priceListModalTitle"
       aria-hidden="true">
       <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
           <div class="modal-content">
               <div class="modal-header">
                   <h5 class="modal-title" id="priceListModalTitle">Perbandingkan Harga Produk Serupa
                   </h5>
                   <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                       <span aria-hidden="true">&times;</span>
                   </button>
...
?>
                       ...
                       <?php $jarak = round(distance($item['lat'], $item['lng'], $key->lat, $key->lng));?>
                       <?php if ($jarak < 10): ?>

                       <div class="col-md-6 col-lg-6 ftco-animate">
                           <div class="product text-center">
                               <a href="<?php echo site_url('item/show/') . $key->id ?>" class="img-prod"><img
                                       width="50%" height="50%" class="img-fluid" src="<?php $photos = explode(',', $key->photo);
    echo base_url('assets/uploads/') . $photos[0]?>" alt="">
                               ...
                               <div class="text py-3 pb-4 px-3 text-center">
                                   <h3><a
                                           href="<?php echo site_url('item/show/') . $key->id ?>"><?php echo $key->name ?></a>
                                   </h3>
                                   <p><?=$key->warung?> (jarak dari warung <?=$key->warung?> adalah <?=$jarak?>
                                       Kilometer
                                       (KM))</p>
                                   <div class="pricing">
                                       <p class="price text-center"><span
                                               class="mr-2"><?php echo "Rp " . number_format($key->price, 0, ".", ".") ?></span>
                                       </p>
                                   </div>
