        ...
        <div class="row">
            <div class="col-md-6">
                <div class="modal-review-img">
                    <img height="75%" width="75%" class="img-fluid  border-around" src="<?php $photos = explode(',', $item['photo']);
            ...
            <div class="col-md-6">
                ...
                <form action="<?php echo site_url('rating/store/') . $item['id'] ?>" class="form-box" method="POST">
                    ...
                    <div class="form-box__single-group">
                        ...
                        <textarea name="review" id="description" placeholder="Tuliskan ulasan anda tentang produk"
                            rows="5"></textarea>
                    </div>
