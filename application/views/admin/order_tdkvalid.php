                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('admin/orders') ?>">Pesanan</a>
                            </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="<?php echo site_url('admin/verif_payment/') . $item['id'] . '/0' ?>"
                                    method="post" enctype='multipart/form-data'>

                                    <div class="form-group row">
                                        <label class="col-md-2 col-form-label">Invoice ID</label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="text" value="<?php echo $item['id'] ?>"
                                                readonly="readonly">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="text" value="<?php echo $item['user'] ?>"
                                                readonly="readonly">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="text"
                                                value="<?php echo $item['warung'] ?>" readonly="readonly">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="text"
                                                value="<?php echo $item['destination'] ?>" readonly="readonly">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="text"
                                                value="<?php echo 'Rp ' . number_format($item['total'], 0, '.', '.'); ?>"
                                                readonly="readonly">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="custom-select" id="inputGroupSelect01" name="alasan">
                                                    <option selected>Choose...</option>
                                                    <?php foreach ($alasan_tolak as $item): ?>
                                    ...
                                    <div class=" mt-4 text-right">
                                        ...
                                        <button class="btn btn-primary waves-effect waves-light" type="submit">Tidak
                                            Valid</button>
                                    </div>
                                </form>
                            </div>
