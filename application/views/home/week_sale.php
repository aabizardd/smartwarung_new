   ...
   <main id="main-container" class="main-container">
       <div class="container">
           <div class="row">
               ...
               <div class="col-12">
                   <?php if (count($week_sale) != 0): ?>
                   <h1 class="sidebar__title">Obral Minggu Ini
                   ...
                   <div class="sort-box m-tb-30">
                       ...
                       <div class="sort-box__left">
                           ...
                           <span>There Are <?=count($week_sale)?> Products.</span>
                       </div> <!-- Start Sort Left Side -->

                       <div class="sort-box__right">
                           <span>Sort By Kategori:</span>
                           <div class="sort-box__option">
                               <label class="select-sort__arrow">
                                   <form>
                                       <select name="select-sort" class="select-sort" name="kategori" id="kategori">
                                           <option value="0" id="pil-kat" onclick="pilih_click()">Pilih</option>
                                           <?php foreach ($categories as $item): ?>

                                           <option value="<?=$item['id']?>" id="pil-kat"><?=$item['name']?></option>
                   ...
                   <script>
                   function pilih_click() {
                       window.location = "<?=base_url('home/week_sale/')?>";
                   }
                   </script>
                   ...
                   function show() {
                       var as = document.forms[0].kategori.value;
